		...
		<div class="col-sm-9">
			...
			<div class="table-responsive">
				<table class="table table-hover">
					<thead>
						<tr>
							<th>ID</th><th></th><th>Reporter</th><th></th><th>Reported</th><th>Post(if any)</th><th>Reason</th>
						</tr>
					</thead>
					<tbody>
						<?php if (count($reported_user_done)> 0): ?>
							<?php foreach ($reported_user_done as $key => $value): ?>
								<tr>
									<td class="td-fit"><?php echo $value["id"]?></td>
									<td class="td-fit">
										<?php if ($value["u1_img"] != null): ?>
